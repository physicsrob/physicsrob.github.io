...
BLOG_AUTHOR = "Rob Porter"  # (translatable)
BLOG_TITLE = "Rob Porter's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
#SITE_URL = "http://physicsrob.github.io/"
SITE_URL = "/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://physicsrob.github.io/"
BLOG_EMAIL = "physicsrob@gmail.com"
BLOG_DESCRIPTION = "Random experiments in AI"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "rob-porters-blog"
...
IPYNB_CONFIG = {'Exporter':{'template_file': 'ipynb'}}
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-124168012-1"></script>
<script>
